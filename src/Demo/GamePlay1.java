 ...
 * @author janip
 */
public class GamePlay1 extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        racket.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Photos/racket1.png"))); // NOI18N
        ...
        racket.setBounds(200, 450, 200, 12);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GamePlay1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
