 ...
 * @author janip
 */
public class GamePlay3 extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        racket.setBounds(250, 450, 100, 10);
        ...
        jLabel26.setBounds(0, -20, 600, 500);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GamePlay3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
